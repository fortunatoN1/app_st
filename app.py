...
############## INCLUSÃO DOS DADOS ##############
    ...
    with col1:
        ...
        if f_formacao !='TODAS AS FORMAÇÕES':
            t1.plotly_chart(px.pie(cargo_fig,values='NUM_SERVIDORES',names = 'CARGO_MAT1',hole =.3).update_traces(textposition='inside'))
            ...
            t1.plotly_chart(px.pie(cargo_form_grupo_total,values='NUM_SERVIDORES',names = 'CARGO_MAT1',hole=.3).update_traces(textposition='inside'))
